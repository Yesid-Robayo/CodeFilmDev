export const LABELS_ES = {
    ...
    addVideoError: 'Error al agregar el video, comprueba los campos e intenta de nuevo',
    /* ------------------B------------- */
    /* ------------------C------------- */
    ...
    errorCreationUser: 'Error al crear el usuario',
    /* ------------------F------------- */
    /* ------------------G------------- */
    ...
    /* ------------------P------------- */
    pass: 'Contraseña',
    passIsError: 'La contraseña es incorrecta',
    /* ------------------Q------------- */
    ...
    userNotEncounter: 'Usuario no encontrado',
    user: 'Usuario',
    /* ------------------V------------- */
    videos: 'Videos',
    ...
    videoCategory: 'Categoria del Video',
